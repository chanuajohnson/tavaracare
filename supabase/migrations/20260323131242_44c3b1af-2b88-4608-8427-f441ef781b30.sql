-- Add matching_requirements column to profiles
ALTER TABLE public.profiles 
  ADD COLUMN IF NOT EXISTS matching_requirements text NULL;

-- Update the one-param update_user_profile function to include matching_requirements
...
-- Update the two-param update_user_profile function to include matching_requirements
