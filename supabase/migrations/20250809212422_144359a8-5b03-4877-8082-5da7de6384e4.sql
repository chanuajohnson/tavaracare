-- Fix reset_user_assignments function to use 'custom' message_type
...
BEGIN
  ...
  -- Update admin interventions to cancelled status
  ...
  -- Log the reset action with valid message_type
