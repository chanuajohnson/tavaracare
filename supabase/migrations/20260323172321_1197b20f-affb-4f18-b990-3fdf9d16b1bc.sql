-- Fix: Remove ::numeric cast from hourly_rate in both update_user_profile functions
-- The hourly_rate column is text type, not numeric

-- 1. Fix one-param version
