...
-- Step 6: Drop existing flyer_locations policy and create new one using has_role
DROP POLICY IF EXISTS "Admins can manage flyer locations" ON public.flyer_locations;
