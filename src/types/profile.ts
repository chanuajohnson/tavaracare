...
/**
 * Frontend model for user profile (camelCase)
 */
 ...
 */
export type DbProfile = Required<Pick<DbProfileInsert, "id" | "created_at" | "updated_at" | "role">> & Omit<DbProfileInsert, "id" | "created_at" | "updated_at" | "role">;
