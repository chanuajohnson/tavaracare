  ...
  const calculateSteps = () => {
    ...
    const steps = [
      ...
      },
      {
        ...
        description: hasCaregiverAssigned ? "Your care team is set up and active" : "Begin your care journey with a scheduled visit from our care coordinators",
        completed: isVisitScheduled || hasCaregiverAssigned,
        accessible: true,
        category: 'scheduling',
        icon_name: 'Calendar',
