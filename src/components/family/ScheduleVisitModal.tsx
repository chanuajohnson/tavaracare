...
export const ScheduleVisitModal = ({ 
  ...
  const [visitCompleted, setVisitCompleted] = useState(false); // This would come from database in real app
  ...
  const handleScheduleVisit = async (visitType: 'virtual' | 'in_person') => {
    if (!user) {
    ...
    try {
      ...
      // Update user profile with visit scheduling status
      ...
      // This would unlock the trial day card
