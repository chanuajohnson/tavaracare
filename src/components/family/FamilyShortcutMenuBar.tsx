  ...
  return <div className="bg-muted py-2 border-y">
      <Container>
        <div className="flex items-center overflow-x-auto whitespace-nowrap py-1 gap-2">
          ...
          {showStoryButton && <Link to="/family/story" onClick={() => handleTrackButtonClick('navigation_click', 'share_story')}>
          ...
          {showRegistrationEdit && <Link to="/registration/family?mode=edit&prefill=true" onClick={() => handleTrackButtonClick('navigation_click', 'edit_profile')}>
          ...
          {showAssessmentEdit && <Link to="/family/care-assessment?mode=edit" onClick={() => handleTrackButtonClick('navigation_click', 'edit_assessment')}>
              <Button variant="outline" size="sm" className="flex items-center gap-1">
          ...
          {isVisitScheduled && <Link to="/family/care-journey-progress#scheduling" onClick={() => handleTrackButtonClick('navigation_click', 'visit_scheduled')}>
              <Button variant="default" size="sm" className="flex items-center gap-1 bg-green-600 hover:bg-green-700 text-white border-green-600">
