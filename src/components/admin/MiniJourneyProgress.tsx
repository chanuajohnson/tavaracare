...
// Temporary context provider for the enhanced journey hook
const TempUserProvider = ({ userId, children }: { userId: string, children: React.ReactNode }) => {
  return <>{children}</>;
};
