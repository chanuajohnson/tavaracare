...
export const PROFESSIONAL_ONBOARDING_SECTION_DEFS: OnboardingSectionDef[] = [
  ...
  },
  {
    ...
    items: [
      "Professional acknowledges they are engaged by the family, with Tavara Care providing coordination, structure, and support",
      ...
      "Professional acknowledges NIS contributions are managed through Tavara's coordination platform on behalf of the family",
