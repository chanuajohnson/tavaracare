...
export const VerificationStatusCard: React.FC<VerificationStatusCardProps> = ({ onStatusChange }) => {
  ...
  const fetchVerificationStatus = async () => {
    ...
    try {
      ...
      if (profile) {
        setVerificationStatus(profile.background_check_status || 'not_started');
        setBadgeEarnedAt(profile.verification_badge_earned_at);
        onStatusChange?.(profile.background_check_status || 'not_started');
      }
    } catch (error: any) {
