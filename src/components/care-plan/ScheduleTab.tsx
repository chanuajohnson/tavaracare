...
export const ScheduleTab: React.FC<ScheduleTabProps> = ({
  ...
  const SHIFT_TITLE_OPTIONS: ShiftTypeOption[] = [
    ...
    { id: "weekday_8am_6pm", label: "Monday - Friday, 8 AM - 6 PM", description: "Standard daytime coverage with extended hours", timeRange: { start: "08:00", end: "18:00" } },
    ...
    { id: "saturday_sunday_8_6", label: "Saturday - Sunday, 8 AM - 6 PM", description: "Weekend daytime coverage with extended hours", timeRange: { start: "08:00", end: "18:00" } },
    ...
    { id: "weekday_evening_4pm_6am", label: "Weekday Evening Shift (4 PM - 6 AM)", description: "Evening care on weekdays after the primary shift ends", timeRange: { start: "16:00", end: "06:00" } },
    { id: "weekday_evening_4pm_8am", label: "Weekday Evening Shift (4 PM - 8 AM)", description: "Evening care on weekdays after the primary shift ends", timeRange: { start: "16:00", end: "08:00" } },
