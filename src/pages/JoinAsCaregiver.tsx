        ...
        <div className="container max-w-6xl mx-auto px-4 py-16 md:py-24 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Your Caregiving Skills Are Needed
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button 
                ...
                className="bg-white text-blue-700 hover:bg-blue-50 text-lg px-8 py-6 font-semibold shadow-lg"
              >
                Join Tavara Today
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </div>
            <p className="text-sm text-blue-200">Free to join • No hidden fees • Start in minutes</p>
          </div>
        </div>
      </section>
