import{r as c,j as e,a as g,B as t,N as f,M as h}from"./index-BFRtxBMG.js";import{I as y}from"./input-Dau18ENS.js";import{B as l}from"./badge-Bzg_1fKV.js";import{A as v,a as b,b as x,c as w}from"./accordion-D5gsWJ4q.js";import{S as q}from"./search-DBI4ujW_.js";import"./index-BH5d_Kb_.js";const d=[{id:"faq-1",question:"What is Tavara.care?",answer:"Tavara.care is a care coordination platform designed to help families, care professionals, and communities connect for better caregiving solutions. We provide tools for care matching, task management, messaging, and professional networking, ensuring quality care experiences.",category:"General"},{id:"faq-2",question:"Who can use Tavara.care?",answer:`Tavara.care is designed for three primary user groups:
...
✔ Submit a Support Ticket`,category:"Support"}];function F(){const[s,r]=c.useState(""),[n,i]=c.useState(null),m=Array.from(new Set(d.map(a=>a.category))),o=d.filter(a=>{const u=a.question.toLowerCase().includes(s.toLowerCase())||a.answer.toLowerCase().includes(s.toLowerCase()),p=n?a.category===n:!0;return u&&p});return e.jsxs("div",{className:"container mx-auto py-8 px-4 max-w-4xl",children:[e.jsxs("div",{className:"text-center mb-8",children:[e.jsx("h1",{className:"text-3xl font-bold mb-2",children:"Frequently Asked Questions"}),e.jsx("p",{className:"text-muted-foreground",children:"Find answers to common questions about the Tavara.care"})]}),e.jsxs("div",{className:"mb-8",children:[e.jsxs("div",{className:"relative mb-4",children:[e.jsx(q,{className:"absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground h-4 w-4"}),e.jsx(y,{type:"text",placeholder:"Search for questions or answers...",value:s,onChange:a=>r(a.target.value),className:"pl-10"})]}),e.jsxs("div",{className:"flex flex-wrap gap-2",children:[e.jsx(l,{variant:n===null?"default":"outline",className:"cursor-pointer",onClick:()=>i(null),children:"All"}),m.map(a=>e.jsx(l,{variant:n===a?"default":"outline",className:"cursor-pointer",onClick:()=>i(a===n?null:a),children:a},a))]})]}),o.length>0?e.jsx(v,{type:"single",collapsible:!0,className:"w-full",children:o.map(a=>e.jsxs(b,{value:a.id,children:[e.jsx(x,{className:"text-left",children:a.question}),e.jsx(w,{children:e.jsx("p",{className:"text-muted-foreground whitespace-pre-line",children:a.answer})})]},a.id))}):e.jsxs("div",{className:"text-center py-8",children:[e.jsx(g,{className:"mx-auto h-12 w-12 text-muted-foreground mb-4"}),e.jsx("h3",{className:"font-medium text-lg mb-1",children:"No results found"}),e.jsx("p",{className:"text-muted-foreground mb-4",children:"We couldn't find any FAQs matching your search criteria"}),e.jsx(t,{onClick:()=>{r(""),i(null)},children:"Clear filters"})]}),e.jsxs("div",{className:"mt-12 bg-muted rounded-lg p-6",children:[e.jsx("h2",{className:"text-xl font-semibold mb-4",children:"Still need help?"}),e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"flex items-start space-x-3",children:[e.jsx("div",{className:"bg-primary/10 p-2 rounded-full",children:e.jsx(f,{className:"h-5 w-5 text-primary"})}),e.jsxs("div",{children:[e.jsx("h3",{className:"font-medium",children:"WhatsApp Support"}),e.jsx("p",{className:"text-sm text-muted-foreground mb-2",children:"Get quick support via WhatsApp"}),e.jsx(t,{variant:"outline",size:"sm",onClick:()=>{window.open(`https://wa.me/18687865357?text=${encodeURIComponent("Hello, I need support with Tavara.care platform.")}`,"_blank")},children:"Connect on WhatsApp"})]})]}),e.jsxs("div",{className:"flex items-start space-x-3",children:[e.jsx("div",{className:"bg-primary/10 p-2 rounded-full",children:e.jsx(h,{className:"h-5 w-5 text-primary"})}),e.jsxs("div",{children:[e.jsx("h3",{className:"font-medium",children:"Contact Form"}),e.jsx("p",{className:"text-sm text-muted-foreground mb-2",children:"Submit a detailed support request"}),e.jsx(t,{variant:"outline",size:"sm",onClick:()=>{alert("Contact form would open here")},children:"Open Contact Form"})]})]})]})]})]})}export{F as default};
